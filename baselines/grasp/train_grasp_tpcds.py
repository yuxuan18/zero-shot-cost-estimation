...
template2queries, template2cards, test_template2queries, test_template2cards, _, _ , _,  = read_query_file(table2id, col2minmax, col2id, global_col2id, file_path='./queries/tpcds_join_reorder.csv')
