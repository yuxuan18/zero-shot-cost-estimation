...
import arcdf.utils as utils
from arcdf import transforms
from arcdf.transforms import made as made_module
from arcdf.transforms import splines
...
def main():
    ...
    print(inputs)
    outputs, logabsdet = transform(inputs, None)
    print(outputs)

    outputs, logabsdet = transform(inputs2, None)
    print(outputs)
