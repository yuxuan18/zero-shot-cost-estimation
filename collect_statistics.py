...
if dataset == "devmind":
    test_data = "data/devmind/devmind_test_data.json"
elif dataset == "tpcds":
    test_data = "data/tpcds/tpcds_test_data.json"
elif dataset == "tpch":
    test_data = "data/tpch/test_data.json"
...
with open(f"data/{dataset}/model_qerror.csv", "w") as f:
    writer = csv.writer(f)
    for qerror in model_qerror:
        writer.writerow([qerror])

with open(f"data/{dataset}/krypton_qerror.csv", "w") as f:
    writer = csv.writer(f)
